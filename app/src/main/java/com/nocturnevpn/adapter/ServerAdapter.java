...
import com.nocturnevpn.utils.OvpnUtils;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == VIEW_TYPE_SHIMMER) {
			...
			if (!adHolder.initialized) {
				...
				com.nocturnevpn.view.managers.BannerAdManager.Companion.getInstance(adView.getContext()).initializeBannerAd(adView, null, null);
