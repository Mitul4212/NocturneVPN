...
public class Server implements Parcelable {
    ...
    // The Server class implements Parcelable to allow instances of this class to be passed between components in Android (e.g., through Intents or Bundles).
    ...
    // Constructor to initialize the Server object with certain attributes.
    ...
    // Reads data from a Parcel to restore the Server object.
